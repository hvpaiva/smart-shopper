...
sonarqube {
    properties {
        ...
        property(
            "sonar.exclusions",
            "src/main/kotlin/dev/hvpaiva/smart/shopper/shopping/list/ShoppingListApplication.kt,src/test/kotlin/dev/hvpaiva/smart/shopper/shopping/list/ShoppingListApplicationTests.kt"
        )
    }
}